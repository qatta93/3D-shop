...
export const ProductCard = (item) => {
  ...
  return (
    <div className="w-full mb-28 border-1 bg-white border-indigo-600 h-72 shadow-xl md:w-[600px] xl:w-[500px] xl:mx-12 md:rounded-xl cursor-pointer" onClick={() => setShowDetails(!showDetails)}>
