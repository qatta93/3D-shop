...
export const ProductCard = (item) => {
  ...
  return (
    <div className="w-full mb-12 md:mb-20 border-1 bg-white border-indigo-600 shadow-xl md:w-[600px] xl:w-[500px] xl:mx-12 md:rounded-xl cursor-pointer" onClick={() => setShowDetails(!showDetails)}>
